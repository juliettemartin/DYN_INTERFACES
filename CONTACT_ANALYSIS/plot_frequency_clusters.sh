...
awk '{print "\t:"$2".A\t"$3}' var_left_residues.txt >> res_attributes.txt
awk '{print "\t:"$2".B\t"$3}' var_right_residues.txt >> res_attributes.txt
...
echo rangecol contact_var min blue max red novalue yellow >> command.cmd
